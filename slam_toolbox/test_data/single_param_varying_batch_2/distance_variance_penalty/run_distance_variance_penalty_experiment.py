...
# e.g.
    # rosrun custom_nav_bench_demo run_distance_variance_penalty_experiment.py \
    #   2> >(sed -e '/TF_REPEATED_DATA/,/buffer_core\.cpp/d' -e '/buffer_core\.cpp/d' >&2) \
...
def run_auto_tests(show_gazebo=False):
    ...
    def getTasks():
        ...
        # did not run properly in the main batch2 (because of slam_toolbox dynamic params issues), so rerunning here
        default_handling_params = {'distance_variance_penalty': 1.0 }
